...
namespace DotnetIteration
{
   ...
   */
    ...
    {
      //bool everyOneIsOdd = data.Any(dataOf => dataOf % 2 >= 1);
      //everyOneIsOdd = !everyOneIsOdd;
    ...
    {
      var findTheNeedle = data.Contains("needle");
      {
        return data.Contains("needle").Select(data.string);
      }
    }
